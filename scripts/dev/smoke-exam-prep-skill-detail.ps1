...
try {
    ...
    $checks = [ordered]@{
        ...
        "v439_detail_has_compact_marker" = ($derivate -cmatch "exam-prep-skill-detail-compact-v0439")
        "v439_detail_has_compact_style" = ($derivate -cmatch "exam-prep-skill-detail-compactness-v0439")
        "v439_detail_has_compact_note" = ($derivate -cmatch "Detaliu skill compact")
        "v439_detail_keeps_existing_sections" = ($derivate -cmatch "exam-prep-skill-metadata-v0427" -and $derivate -cmatch "exam-prep-learning-path-v0431" -and $derivate -cmatch "exam-prep-related-study-questions-v0415" -and $derivate -cmatch "exam-prep-study-session-entry-v0435" -and $derivate -cmatch "exam-prep-progress-interpretation-v0436" -and $derivate -cmatch "exam-prep-next-action-v0416" -and $derivate -cmatch "exam-prep-weak-review-entry-v0428")
        "v439_detail_order_metadata_learning_related_study_progress_next_weak" = ($derivate.IndexOf("exam-prep-skill-metadata-v0427") -ge 0 -and $derivate.IndexOf("exam-prep-learning-path-v0431") -gt $derivate.IndexOf("exam-prep-skill-metadata-v0427") -and $derivate.IndexOf("exam-prep-related-study-questions-v0415") -gt $derivate.IndexOf("exam-prep-learning-path-v0431") -and $derivate.IndexOf("exam-prep-study-session-entry-v0435") -gt $derivate.IndexOf("exam-prep-related-study-questions-v0415") -and $derivate.IndexOf("exam-prep-progress-interpretation-v0436") -gt $derivate.IndexOf("exam-prep-study-session-entry-v0435") -and $derivate.IndexOf("exam-prep-next-action-v0416") -gt $derivate.IndexOf("exam-prep-progress-interpretation-v0436") -and $derivate.IndexOf("exam-prep-weak-review-entry-v0428") -gt $derivate.IndexOf("exam-prep-next-action-v0416"))
