...
replacement = r'''def parse_words(tsv: str, min_conf: float = -1.0) -> list[dict]:
    ...
    for row in reader:
        # Normalize TSV keys. Some Windows/Tesseract builds may include BOM/spaces.
        clean_row = {
...
print("OK: TSV parser made robust and diagnostics added.")
