...
Write-Output "v0.7.99 Manual Learning Evidence metadata preview binding check: start"
...
python -m py_compile scripts/dev/check-manual-learning-evidence-metadata-preview-binding-no-save-no-build-no-zip-no-delivery.py
...
python scripts/dev/check-manual-learning-evidence-metadata-preview-binding-no-save-no-build-no-zip-no-delivery.py
