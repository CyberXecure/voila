...
def render_exam_prep_skill_detail_page(skill_id: str) -> tuple[str, int]:
    ...
    html = (
        ...
        '<style>'
        'body{font-family:system-ui,-apple-system,Segoe UI,sans-serif;margin:0;background:#11191c;color:#f8efe5;}'
        'main{max-width:1180px;margin:0 auto;padding:32px 20px 72px;}'
        '.card{background:#243238;border:1px solid rgba(230,181,111,.28);border-radius:24px;padding:28px;box-shadow:0 18px 44px rgba(0,0,0,.24);}'
        '.muted{color:#d8c8b5;line-height:1.55;}'
        '.actions{display:flex;flex-wrap:wrap;gap:10px;margin-top:20px;}'
        '.button{display:inline-flex;align-items:center;justify-content:center;border-radius:999px;padding:10px 14px;text-decoration:none;border:1px solid rgba(230,181,111,.36);color:#f8efe5;background:#1d292e;font-weight:650;}'
        '.button.primary{background:#e4ae67;color:#111b1f;border-color:#e4ae67;}'
        '.metric-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:12px;margin:18px 0;}'
        '.metric{background:#1d292e;border:1px solid rgba(230,181,111,.22);border-radius:16px;padding:16px;color:#f8efe5;}'
        '.metric strong{display:block;font-size:1.35rem;margin-top:4px;}'
        '.study-entry{margin-top:22px;background:#1d292e;border:1px solid rgba(230,181,111,.22);border-radius:18px;padding:18px;color:#f8efe5;}'
        '.study-entry h2{margin:0 0 10px;font-size:1.15rem;}'
        '.study-steps{margin:0;padding-left:22px;color:#d8c8b5;line-height:1.6;}'
        '.study-steps li{margin:6px 0;}'
        'h1,h2,h3,strong{color:#fff6ea;}p,li,span,small,dd{color:#d8c8b5;}a{color:#e4ae67;}.exam-prep-skill-detail-links,.exam-prep-related-study-questions-v0415,.exam-prep-next-action-v0416,.exam-prep-skill-metadata-v0427,.exam-prep-learning-path-v0431,.exam-prep-study-session-entry-v0435{background:#243238!important;border-color:rgba(230,181,111,.28)!important;color:#f8efe5!important;box-shadow:0 12px 30px rgba(0,0,0,.18)!important;}.exam-prep-skill-detail-links p,.exam-prep-related-study-questions-v0415 p,.exam-prep-next-action-v0416 p,.exam-prep-skill-metadata-v0427 p,.exam-prep-learning-path-v0431 p,.exam-prep-study-session-entry-v0435 p{color:#d8c8b5!important;}.skill-link-grid a{background:#1d292e!important;border:1px solid rgba(230,181,111,.22)!important;color:#fff6ea!important;border-radius:14px!important;}</style></head><body><main><div class="card">'
...
def render_exam_prep_dashboard_compactness_style_html() -> str:
    return (
        ...
        '/* v0.7.38 Exam Prep full-page Voila theme alignment */'        '.exam-prep-dashboard-consolidated-v0422{display:grid;gap:16px;color:#f8efe5!important;}'        '.exam-prep-dashboard-consolidated-v0422 .exam-prep-dashboard-compact-note-v0438{color:#9fb0b8!important;-webkit-text-fill-color:#9fb0b8!important;}'        '.exam-prep-dashboard-consolidated-v0422 section,.exam-prep-dashboard-consolidated-v0422 article{background:#243238!important;border-color:rgba(230,181,111,.28)!important;color:#f8efe5!important;-webkit-text-fill-color:#f8efe5!important;box-shadow:0 10px 28px rgba(0,0,0,.18)!important;}'        '.exam-prep-dashboard-consolidated-v0422 section [style*="background:#f8fafc"],.exam-prep-dashboard-consolidated-v0422 article [style*="background:#f8fafc"],.exam-prep-dashboard-consolidated-v0422 section [style*="background:#fff"],.exam-prep-dashboard-consolidated-v0422 article [style*="background:#fff"]{background:#1d292e!important;border-color:rgba(230,181,111,.22)!important;}'        '.exam-prep-dashboard-consolidated-v0422 h1,.exam-prep-dashboard-consolidated-v0422 h2,.exam-prep-dashboard-consolidated-v0422 h3,.exam-prep-dashboard-consolidated-v0422 strong,.exam-prep-dashboard-consolidated-v0422 dt{color:#fff6ea!important;-webkit-text-fill-color:#fff6ea!important;font-weight:800!important;}'        '.exam-prep-dashboard-consolidated-v0422 p,.exam-prep-dashboard-consolidated-v0422 span,.exam-prep-dashboard-consolidated-v0422 small,.exam-prep-dashboard-consolidated-v0422 dd,.exam-prep-dashboard-consolidated-v0422 li{color:#d8c8b5!important;-webkit-text-fill-color:#d8c8b5!important;}'        '.exam-prep-dashboard-consolidated-v0422 a{background:#e4ae67!important;border-color:#e4ae67!important;color:#111b1f!important;-webkit-text-fill-color:#111b1f!important;text-decoration:none!important;font-weight:750!important;}'        '.exam-prep-dashboard-consolidated-v0422 a *{color:#111b1f!important;-webkit-text-fill-color:#111b1f!important;}'        '</style>'
    )
