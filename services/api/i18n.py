...
TRANSLATIONS = {
    "ro": {
        ...
        "message.return_to_library_description": "Revino la biblioteca principală.",
        "message.progress_description": "Vezi progresul studiului.",
        "message.edit_crops_description": "Editează manual decupajele figurilor.",
        "message.figures_description": "Vezi figurile extrase.",
        "message.review_concepts_description": "Corectează titlurile lecțiilor și conceptelor.",
        "message.review_ocr_text_description": "Corectează textul OCR pagină cu pagină.",
        "message.study_mode_description": "Exersează întrebări generate din curs.",
        "message.lessons_description": "Alege o lecție, citește-o, apoi studiază doar acea lecție.",
        "message.open_course_description": "Citește cursul generat cu navigare.",
        "ui.review_study_concepts": "Revizuire concepte de studiu",
        "ui.review_ocr_text": "Revizuire OCR",
        "ui.lessons": "Lecții",
        ...
        "ui.regenerate_course": "Regenerează cursul",
        ...
        "message.limited_tester_demo_notice": "<strong>Voila! Demo limitat pentru testeri:</strong> maximum 12 pagini per PDF. Folosește doar documente mici, neconfidențiale.",
        ...
        "review_schedule": "Program revizuire",
        "review_bucket": "Categorie revizuire",
        "next_review": "Următoarea revizuire",
        "review_delay_days": "Zile până la revizuire",
        ...
        "ui.heading.review_due_concepts": "Voila! Revizuire programată",
        "ui.link.next_review": "Următoarea revizuire",
        "ui.heading.review_question": "Întrebare de revizuire",
        "next_review_action": "Următoarea revizuire",
        "no_due_now_concepts_yet": "Nu există concepte scadente acum.",
        "no_due_today_concepts_yet": "Nu există concepte scadente azi.",
        "no_due_later_concepts_yet": "Nu există concepte programate mai târziu.",
        "no_mastered_review_concepts_yet": "Nu există concepte pentru revizuire de consolidare.",
        "no_new_concepts_yet": "Nu există concepte noi.",
        "status.status": "Stare",
        ...
        "ui.exam_prep": "Pregătire examene",
        "ui.exam_prep_title": "Voila! Pregătire examene",
        "exam_prep.bac_matematica_m1": "Bacalaureat → Matematică M1",
        "exam_prep.foundation_description": "Panou inițial pentru pregătire pe competențe. Progresul se actualizează din Modul Studiu.",
        "exam_prep.consolidated": "Consolidat",
        "exam_prep.attempts": "Încercări",
        "exam_prep.correct": "Corecte",
        "exam_prep.status.no_attempts": "Nepornit",
        "exam_prep.status.needs_review": "De revizuit",
        "exam_prep.status.in_progress": "În progres",
        "exam_prep.status.almost_consolidated": "Aproape consolidat",
        "exam_prep.status.consolidated": "Consolidat",
        "exam_prep.status_label": "Stare",
    },
    "en": {
        "message.return_to_library_description": "Return to the main course library.",
        "message.progress_description": "View study progress.",
        "message.edit_crops_description": "Manually edit figure crops.",
        "message.figures_description": "View extracted figures.",
        "message.review_concepts_description": "Correct lesson and concept titles.",
        "message.review_ocr_text_description": "Correct OCR text page by page.",
        "message.study_mode_description": "Practice questions generated from the course.",
        "message.lessons_description": "Choose a lesson, read it, then study only that lesson.",
        "message.open_course_description": "Read the generated course with navigation.",
        ...
        "ui.regenerate_course": "Regenerate course",
        ...
        "message.limited_tester_demo_notice": "<strong>Voila! Limited Tester Demo:</strong> maximum 12 pages per PDF. Use only small, non-confidential sample documents.",
        ...
        "review_delay_days": "Review delay days",
        "due_now": "Due now",
        "due_today": "Due today",
        "due_later": "Due later",
        ...
        "ui.exam_prep": "Exam Prep",
        "ui.exam_prep_title": "Voila! Exam Prep",
        "exam_prep.bac_matematica_m1": "Baccalaureate → Mathematics M1",
        "exam_prep.foundation_description": "Foundation dashboard for skill-based exam preparation. Progress is updated from Study Mode.",
        "exam_prep.consolidated": "Mastery",
        "exam_prep.attempts": "Attempts",
        "exam_prep.correct": "Correct",
        "exam_prep.status.no_attempts": "Not started",
        "exam_prep.status.needs_review": "Needs review",
        "exam_prep.status.in_progress": "In progress",
        "exam_prep.status.almost_consolidated": "Almost mastered",
        "exam_prep.status.consolidated": "Mastered",
        "exam_prep.status_label": "Status",
