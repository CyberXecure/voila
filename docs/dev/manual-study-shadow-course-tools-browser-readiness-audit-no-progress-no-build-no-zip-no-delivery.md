# v0.8.25 Manual Study shadow Course Tools browser readiness audit — no Progress/no build/no ZIP/no delivery

## Purpose

This milestone records an owner-local end-to-end browser readiness audit for the Course Tools link to the real `/study` Manual Study shadow route.
...
The Course Tools → Manual Study shadow flow may pass owner-local readiness, but tester readiness remains blocked until a separate explicit milestone approves default Study behavior and then separately approves packaging.
